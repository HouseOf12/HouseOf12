  ...
  const grabComp = () => {
    ...
    const friendData = axios
      .post(
        ...
        {
          p_day: newDate[2] || "10",
          p_month: newDate[1] || "12",
          p_year: newDate[0] || "1990",
          p_hour: newTime[0] || "06",
          p_min: newTime[1] || "16",
          p_lat: "34.1808",
          p_lon: "118.3090",
          p_tzone: "5.5",
          s_day: secondDate[2] || "19",
          s_month: secondDate[1] || "07",
          s_year: secondDate[0] || "1997",
          s_hour: friendTime[0] || "05",
          s_min: friendTime[1] || "30",
          s_lat: "34.1808",
          s_lon: "118.3090",
          s_tzone: "5.5",
        },
